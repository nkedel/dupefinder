...
fun main(args: Array<String>) {
    ...
    try {
        ...
        val timezonesAsStrings = ArrayList<String>()
        ...
        contentPanel.addComponent(Button("Button", Runnable { MessageDialog.showMessageDialog(textGUI, "MessageBox", "This is a message box", MessageDialogButton.OK) }).setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.CENTER, GridLayout.Alignment.CENTER)))
